<?php
function _footer_jwt_payload_evg(string $token): ?array {
    $parts = explode('.', $token);
...
$_payload = !empty($_COOKIE['auth_token']) ? _footer_jwt_payload_evg($_COOKIE['auth_token']) : null;
...
$_roles = [
    'Coordinador' => ['Coordinador', 'badge-admin'],
